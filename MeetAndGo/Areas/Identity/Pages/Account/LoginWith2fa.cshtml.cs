...
namespace MeetAndGo.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(7, ErrorMessage = "{0} musi mieć minimum {2}, a maksymalnie {1} znaków.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            else
            {
                ...
                ModelState.AddModelError(string.Empty, "Niepoprawny kod uwierzytelniający.");
                return Page();
            }
        }
    }
